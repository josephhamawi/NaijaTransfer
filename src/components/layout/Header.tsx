    ...
    <header className={cn("fixed top-0 left-0 right-0 z-50 p-3", className)}>
      ...
      >
        ...
        <nav className="hidden md:flex items-center gap-1" aria-label="Main navigation">
          ...
          <NavLink href="/black-market-exchange-rate">Naira Rate</NavLink>
      ...
      {mobileMenuOpen && (
        ...
        >
          ...
          <MobileNavLink href="/black-market-exchange-rate" onClick={() => setMobileMenuOpen(false)}>Naira Rate</MobileNavLink>
