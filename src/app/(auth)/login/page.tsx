...
/** Show/hide toggle rendered inside a password Input's rightIcon slot. */
        ...
        <Card frosted elevation="xl" padding="lg" className="w-full max-w-full sm:max-w-sm">
          ...
          <div className="space-y-3">
            ...
            <form onSubmit={handleEmail} className="space-y-3">
              ...
              {isSignUp && (
                <Input
                  ...
                  required
                  rightIcon={
                    <PasswordToggle shown={showConfirm} onToggle={() => setShowConfirm((s) => !s)} />
                  }
                />
              )}
            ...
            <p className="text-center text-xs text-[var(--text-muted)] pt-2">
              ...
              <button
                onClick={() => { setIsSignUp(!isSignUp); setError(""); setConfirmPassword(""); setShowPassword(false); setShowConfirm(false); }}
