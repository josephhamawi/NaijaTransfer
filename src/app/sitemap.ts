...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${baseUrl}/black-market-exchange-rate`, lastModified: now, changeFrequency: "hourly", priority: 0.9 },
    { url: `${baseUrl}/dollar-to-naira-black-market`, lastModified: now, changeFrequency: "hourly", priority: 0.85 },
    { url: `${baseUrl}/euro-to-naira-black-market`, lastModified: now, changeFrequency: "hourly", priority: 0.8 },
    { url: `${baseUrl}/pound-to-naira-black-market`, lastModified: now, changeFrequency: "hourly", priority: 0.8 },
