...
const STATIC_ROUTES: { path: string; lastmod: string; changefreq: MetadataRoute.Sitemap[number]["changeFrequency"]; priority: number }[] = [
  ...
  { path: "/yuan-to-naira",                      lastmod: "2026-05-11", changefreq: "daily",   priority: 0.55 },
  { path: "/yen-to-naira",                       lastmod: "2026-05-11", changefreq: "daily",   priority: 0.55 },
  { path: "/australian-dollar-to-naira",         lastmod: "2026-05-11", changefreq: "daily",   priority: 0.55 },
  { path: "/canadian-dollar-to-naira",           lastmod: "2026-05-11", changefreq: "daily",   priority: 0.55 },
  { path: "/indian-rupee-to-naira",              lastmod: "2026-05-11", changefreq: "daily",   priority: 0.55 },
  { path: "/pakistani-rupee-to-naira",           lastmod: "2026-05-11", changefreq: "daily",   priority: 0.55 },
